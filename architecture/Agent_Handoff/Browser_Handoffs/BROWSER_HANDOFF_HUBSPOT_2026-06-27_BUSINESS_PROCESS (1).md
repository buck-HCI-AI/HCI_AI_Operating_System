...
```json
{
  "objects": [
    ...
    {"name":"Tasks","object_type_id":"0-27","record_count":38,"usage_status":"LOW","primary_use":"Manual follow-up reminders only"},
    ...
    {"name":"Meetings","object_type_id":"0-47","meetings_booked":0,"usage_status":"LOW","scheduling_url":"meet.hubspot.com/buck-adams/meeting"},
  ...
  "pipelines": [
    {
      ...
      "purpose": "Track bid opportunities from scope request through award",
      "stages": [
...
```json
[
  {"name":"n8n Construction OS","type":"private_app","app_id":43234028,"scopes":["contacts.read","contacts.write","companies.read","companies.write","deals.read","deals.write"],"webhooks":0,"status":"ACTIVE — PRIMARY AUTOMATION LAYER","recommendation":"EXTEND — add webhooks, bridge to Houzz Pro"},
  {"name":"WF-002 n8n Service Key","type":"private_app","status":"ACTIVE","recommendation":"MAINTAIN"},
  {"name":"HubSpot connector for Claude","status":"ACTIVE","recommendation":"EXTEND — connect to HCI AI OS orchestration"},
  {"name":"HubSpot connector for ChatGPT","status":"ACTIVE","recommendation":"EVALUATE — consolidate with Claude connector"},
  {"name":"HubSpot Payments","transactions":0,"status":"INSTALLED_UNUSED","recommendation":"IGNORE"},
  {"name":"Insycle Data Management","last_used":"2026-01-20","recommendation":"MAINTAIN — quarterly data hygiene"},
  {"name":"Meta Ads","status":"ACTIVE_DAILY","recommendation":"INTEGRATE — sync lead forms to Contacts"},
...
```json
[
  {"id":"AO-HS-001","title":"COI Expiration Auto-Update","value":"HIGH","complexity":"LOW","requires_upgrade":false,"status":"READY_TO_BUILD","description":"Daily n8n cron: compare coi_expiration_date to today, PATCH coi_status on company record"},
  {"id":"AO-HS-002","title":"COI Renewal Email Trigger","value":"HIGH","complexity":"LOW","requires_upgrade":false,"status":"READY_TO_BUILD","description":"30 days before COI expiration send renewal request email to primary contact"},
  {"id":"AO-HS-003","title":"Deal Stage to Houzz Pro Project Bridge","value":"HIGH","complexity":"MEDIUM","requires_upgrade":false,"status":"PENDING_HOUZZ_API_DISCOVERY","description":"When deal moves to ROM Accepted/Job Won auto-create Houzz Pro project via Zapier or n8n"},
  {"id":"AO-HS-004","title":"Bid Invitation Auto-Task Creation","value":"HIGH","complexity":"LOW","requires_upgrade":false,"status":"READY_TO_BUILD","description":"When deal stage = Sent Out create tasks for all associated contacts"},
  {"id":"AO-HS-005","title":"Subcontractor COI Submission Form","value":"HIGH","complexity":"LOW","requires_upgrade":false,"status":"READY_TO_BUILD","description":"HubSpot form for subs to submit COI auto-updates company coi fields"},
  ...
  {"id":"AO-HS-007","title":"Sales Hub Professional Upgrade","value":"HIGH","complexity":"LOW","estimated_cost":"~$70/month incremental","estimated_roi":"7+ hours/week manual work eliminated","status":"EXECUTIVE_DECISION_REQUIRED"},
  {"id":"AO-HS-008","title":"Pipeline Overview Dashboards","value":"HIGH","complexity":"LOW","requires_upgrade":false,"status":"READY_TO_BUILD","description":"Build 4 dashboards: Pipeline Overview, Sub Vendor, Bidding Activity, COI Compliance"},
  {"id":"AO-HS-009","title":"ROM Quote Automation","value":"HIGH","complexity":"MEDIUM","status":"FUTURE_PHASE"},
  {"id":"AO-HS-010","title":"AI Deal Summarization","value":"HIGH","complexity":"MEDIUM","requires_upgrade":false,"status":"READY_TO_BUILD","description":"n8n retrieves engagements, passes to Claude API, returns executive briefing"}
]
```
...
```json
[
  {"gap":"No HubSpot to Houzz Pro integration","impact":"Dual manual data entry; data drift between systems","priority":"P0"},
  {"gap":"No webhooks configured","impact":"Poll-based only; no real-time triggers; API waste","priority":"P1"},
  {"gap":"Workflows locked on Starter plan","impact":"Cannot build automations or sequences","priority":"P1","fix":"Upgrade to Sales Hub Professional"},
  {"gap":"COI Status not automated","impact":"Expired COI companies may appear on active projects","priority":"P1","fix":"AO-HS-001 + AO-HS-002"},
  {"gap":"Zero dashboards or reports","impact":"No pipeline visibility for leadership","priority":"P2","fix":"AO-HS-008"}
]
```
...
[
  ...
  "Design AO-HS-003: HubSpot-to-Houzz Pro bridge architecture"
]
```
